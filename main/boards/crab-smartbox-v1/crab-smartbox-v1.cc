...
// CrabSmartBox v1 专用显示类
class CrabSmartBoxDisplay : public SpiLcdDisplay {
public:
    CrabSmartBoxDisplay(esp_lcd_panel_io_handle_t io_handle,
...
class CrabSmartBoxBacklight : public Backlight {
public:
    CrabSmartBoxBacklight(esp_lcd_panel_io_handle_t panel_io) : Backlight(), panel_io_(panel_io) {}
...
class CrabSmartBoxV1 : public WifiBoard {
private:
    i2c_master_bus_handle_t codec_i2c_bus_;
    Pmic* pmic_ = nullptr;
    Button boot_button_;
    CrabSmartBoxDisplay* display_;
    CrabSmartBoxBacklight* backlight_;
    ...
    void InitializeTca9554(void) {
        // TCA9554 support disabled - chip not supported
        /*
        ...
        ESP_ERROR_CHECK(ret);
        */
        ESP_LOGI(TAG, "TCA9554 initialization skipped - chip not supported");
    }
    ...
    void InitializeSt7789Display() {
        ...
        display_ = new CrabSmartBoxDisplay(panel_io, panel,
                                          DISPLAY_WIDTH, DISPLAY_HEIGHT, 
                                          DISPLAY_OFFSET_X, DISPLAY_OFFSET_Y, 
                                          DISPLAY_MIRROR_X, DISPLAY_MIRROR_Y, DISPLAY_SWAP_XY);
        backlight_ = new CrabSmartBoxBacklight(panel_io);
...
public:
    CrabSmartBoxV1() : boot_button_(BOOT_BUTTON_GPIO) {
        ESP_LOGI(TAG, "Initializing CrabSmartBox V1 board");
